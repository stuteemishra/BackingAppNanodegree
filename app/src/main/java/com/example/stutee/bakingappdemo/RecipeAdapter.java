...
public class RecipeAdapter extends RecyclerView.Adapter<RecipeAdapter.RecipeAdapterViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecipeAdapter.RecipeAdapterViewHolder holder, int position) {
        ...
        holder.recipeNameTv.setPaintFlags(holder.recipeNameTv.getPaintFlags()| Paint.UNDERLINE_TEXT_FLAG);
        ...
        Picasso.with(mContext).load(currentUrl)
                .into(holder.recipeDefaultImageView);
    ...
    public class RecipeAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @BindView(R.id.recipe_image_default)
        ImageView recipeDefaultImageView;
